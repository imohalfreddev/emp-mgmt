...
// ==========================================
// VERSION 1 (Includes Landing Page)
// ==========================================
function AppContent() {
...
// ==========================================
// VERSION 2 (Alternate - Defaults to Signup)
// Renamed to avoid crashing your app!
// ==========================================
function AppContentAlternate() {
  const { user, loading } = useAuth();
  const { dark } = useTheme();
